...
import com.example.chatwebproject.model.request.TranslateRequest;
...
public class MessageController {
    ...
    public ResponseEntity<BaseResponse> translate(@PathVariable Long messageId, @RequestBody TranslateRequest request) {
        return this.respFactory.success(messageService.translateMessage(messageId, request.getSourceLanguage(), request.getTargetLanguage()));
    }
}
